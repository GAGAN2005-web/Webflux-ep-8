...
@RequestMapping("/products") public class ProductController { 
    ...
    @GetMapping     public Flux<Product> all() {         return service.getAll(); 
    } 
 
    @GetMapping("/{id}")     public Mono<ResponseEntity<Product>> one(@PathVariable String id) {         return service.getById(id) 
